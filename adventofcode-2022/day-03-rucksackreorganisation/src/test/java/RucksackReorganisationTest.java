...
class RucksackReorganisationTest {
	...
	public void commonItemsCanBeIdentifiedOnlyWhenCasesMatch() {
		...
		List<Character> foundSharedChars = rucksackReorganisation.findCommonCharacters( input );
	...
	public void pointsAreDefinedForLowerCaseAcceptableCharacters() {
		...
		//16 + 22 + 20 + 19 = 77
		List<Character> foundSharedChars = rucksackReorganisation.findCommonCharacters( input );
		int calculateTotal = rucksackReorganisation.calculatePointsForCommonCharacters(
				foundSharedChars );
	...
	public void findsNothingIfNoCommonCharacterInAGroupOfThreeEntries() {
		...
		List<Character> foundChars = rucksackReorganisation.findCommonCharactersInASeriesOfEntries(
				input );
	...
	public void findCommonCharactersInAChunkOfEntries() {
		...
		int expectedPoints = rucksackReorganisation.calculatePointsForCommonCharacters(
				expectedCharacters );
		int totalPoints = rucksackReorganisation.checkCommonCharactersInChunksOfUpToThreeEntries(
				entries );
	...
	public void identificationOfCommonCharsThroughGroupsOfEntriesAgainstRealFileWorks() {
		int totalPoints = rucksackReorganisation.runIdentificationOfCommonCharacters( "input.txt" );
